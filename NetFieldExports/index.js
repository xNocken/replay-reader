module.exports = [
  ...
  require('./FortBroadcastRemoteClientInfo.json'),
  require('./FortBroadcastRemoteClientInfoCache.json'),
  require('./FortBroadcastRemoteClientInfo_ClientRemotePlayerHitMarkers.json'),
  require('./FortBroadcastSpectatorInfo.json'),
